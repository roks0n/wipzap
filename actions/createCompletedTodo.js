...
module.exports = {
  ...
  operation: {
    ...
    // In cases where Zapier needs to show an example record to the user, but we are unable to
    // get a live example from the API, Zapier will fallback to this hard-coded sample. It should
    // reflect the data structure of returned records, and have obviously dummy values that we
    // can show to any user.
    sample: {
      id: 107770,
